...
// Private recursive delete all nodes
void jw::BinaryTree::deleteNode(TreeNode* tree) {
  if (tree->left)
...
jw::BinaryTree &jw::BinaryTree::operator=(jw::BinaryTree &sourceTree) {
  clear();
